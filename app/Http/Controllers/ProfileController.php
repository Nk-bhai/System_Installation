...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($request->input('avatar_remove')) {
            ...
            try {
                $response = Http::post("http://192.168.1.11:8005/api/superadmin/remove_profile_logo/{$ip_address}");
        ...
        if ($request->hasFile('avatar')) {
            ...
            try {
                ...
                $response = Http::attach(
                    ...
                    $fileName
                )->post("http://192.168.1.11:8005/api/superadmin/profile_logo/{$ip_address}");
